...
- ❌ **echo-proto (旧)**: 约 150 个 API (21% 完整) - **已放弃**
- ✅ **决策**: 放弃 teamgram-proto，从 TLRPC.java 生成完整 700 个 API
...
#### 目标
自动生成 RPC 路由注册代码，**一次性注册所有 700 个 API**
...
1. ✅ 立即开始开发生成器
2. ✅ 3-4 周完成
3. ✅ 一次性生成完整 700 个 API 定义（放弃不完整的 teamgram-proto）
